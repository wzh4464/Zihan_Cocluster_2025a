...
\textbf{Code and Reproducibility:} For peer review, we provide a fully executable anonymous archive containing source code, containers, and workflows; editors and reviewers have access via a private link. Upon acceptance, we will de-anonymize and mint a DOI. The package includes:
\begin{itemize}
